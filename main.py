...
if __name__ == '__main__':
    ...
    for subject in scores.keys():
        score1 = int(input("From a scale of 0 to 5, How much do you like " + subject + "?:\n"))
        while score1 < 0 or score1 > 5:
            score1 = int(input("Please input a value between 0 and 5:\n"))

        if subject == "Economics":
            score2 = score1
        else:
            score2 = int(input("From a scale of 0 to 5, what is your average mark in " + subject + "?:\n"))
            while score2 < 0 or score2 > 5:
                score2 = int(input("Please input a value between 0 and 5:\n"))
    ...
    print('Your top 5 choices are:')
    for idx in range(5):
        selection = all_selections[idx]
        print('(' + str(idx+1) + ') ' + ', '.join(selection[0]) + ', with a score of ' + str(selection[1]) + '.')
